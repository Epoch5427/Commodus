...
from .window import CommodusWindow


class CommodusApplication(Adw.Application):
    """The main application singleton class."""



    def __init__(self):
        super().__init__(application_id='io.github.Epoch5427.Commodus',
    ...
    def do_activate(self):
        ...
        if not win:
            win = CommodusWindow(application=self)
        win.present()
